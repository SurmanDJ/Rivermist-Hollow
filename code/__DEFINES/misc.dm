...
#define HOOD_LAYER				17
#define HAIR_LAYER				16		//TODO: make part of head layer?
#define MASK_LAYER				15
#define HAIREXTRA_LAYER			14
#define MOUTH_LAYER				13
#define HEAD_LAYER				12
#define BACK_LAYER				11		//only when looking north
#define HANDS_LAYER				10
#define HANDCUFF_LAYER			9
#define LEGCUFF_LAYER			8
#define BODY_FRONT_LAYER		7
#define BODY_FRONT_FRONT_LAYER	6
#define BODY_FRONT_FRONT_FRONT_LAYER	5
